...
| **Phase 2 sample configs** | `observability/prometheus-sideweed.yml`, `observability/sideweed-alert-rules.yml`, **`observability/vmalert-sideweed-rules.yml`** |
...
| **Sample scrape + alert rules** | [observability/prometheus-sideweed.yml](../observability/prometheus-sideweed.yml), [observability/sideweed-alert-rules.yml](../observability/sideweed-alert-rules.yml), **[observability/vmalert-sideweed-rules.yml](../observability/vmalert-sideweed-rules.yml)** + [VMALERT-INTEGRATION.md](VMALERT-INTEGRATION.md) |
...
| [observability/vmalert-sideweed-rules.yml](../observability/vmalert-sideweed-rules.yml) | **vmalert** rules для production stack (7 alerts) |
| [VMALERT-INTEGRATION.md](VMALERT-INTEGRATION.md) | Scrape + deploy outline |

Проверка: `promtool check rules observability/sideweed-alert-rules.yml`; vmalert/PyYAML — см. [VMALERT-INTEGRATION.md](VMALERT-INTEGRATION.md).
