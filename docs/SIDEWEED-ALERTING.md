...
**Delivery в production** (Alertmanager/webhook) **не реализован** — только design и reference configs для согласования с monitoring stack заказчика.
...
**Текущий статус:** Phase 1 ✓, Phase 2 sample configs ✓, **delivery / compose profile — pending**.
...
| **6.4 Alerting** | **Partial** | Delivery: Alertmanager/webhook в prod | Customer monitoring stack |
...
*Документ по Задаче №3 §6.4. Metrics и sample rules в repo; Alertmanager delivery — pending.*
